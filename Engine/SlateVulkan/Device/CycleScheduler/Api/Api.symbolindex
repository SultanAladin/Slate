...
S CycleScheduler.h | 130 lines | 5153e5d4 | 11 sym | Orders reuse of N cyclic recording slots — the wait that makes a slot writable and the ordinal that names it.

//------------------------------------------------------------------------------------------------------------------------
//                                                   ONE ROTATION SLOT
//------------------------------------------------------------------------------------------------------------------------

T RotationSlot                       | CycleScheduler.h | 30-35  | nonallocating,nonthrowing     | -  | What one cyclic slot holds — the ordering points a recording against it waits on and signals. ever been submitted, and an unsignalled one waits for a submission that will never arrive — a bring-up that stops before its first image, with no operand and no error.
    has   Completion     VkFence      [-]  ?
    has   ImageArrived   VkSemaphore  [-]  ?
    has   RecordingDone  VkSemaphore  [-]  ?
    by    Api/CommandSequence.h, Api/DescriptorIndex.h, Api/DisplayScheduler.h, Api/HardwareMetrics.h, Api/OcclusionScheduler.h, Api/VisibilityRaster.h, (+7 more)
...
F CycleScheduler::~CycleScheduler    | CycleScheduler.h | 55     | destructor                    | -  | ?
...
F CycleScheduler::Advance            | CycleScheduler.h | 92     | api,nonallocating,nonthrowing | ✔️ | Carries the standing ordinal to the next slot in the cycle.
    out   -  void  [-]  ?
...
F CycleScheduler::CompletedRotations | CycleScheduler.h | 108    | api,nonallocating,nonthrowing | ✔️ | How many rotations have been advanced through since bring-up, for `86`'s pacing report.
    out   -  std::uint64_t  [-]  ?
    by    Source/CycleScheduler.cpp

F CycleScheduler::Reclaim            | CycleScheduler.h | 114    | api,nonthrowing               | 🚩 | Destroys every ordering point.
    out   -  void  [-]  ?
    pre   the device is idle
    by    Api/AttachmentIndex.h, Api/ByteSpace.h, Api/CodeInterchange.h, Api/CommandSequence.h, Api/DepthReduction.h, Api/DescriptorIndex.h, (+75 more)

...
public:
    ...
    /// cost  🚩
    /// tag   api, nonthrowing
    Outcome<ArrivedImage> Await(const RotationSlot& Standing, const TickSequence& Timeline);
    ...
    /// cost  🚩
    /// tag   api, nonthrowing
    Outcome<bool> Present(const RotationSlot& Standing, std::uint32_t ImageOrdinal);

...
Outcome<bool> PanelStructure::Proportion(std::uint32_t DivisionOrdinal, float LeastFraction)
{
...
Outcome<PanelRecord> PanelStructure::Standing(std::uint32_t Ordinal) const
{

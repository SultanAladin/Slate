...
//                                                           INTERACTIONINDEX.H
//============================================================================================================================================
// 🧩 A generational slot ledger of live control interaction — the one grab, the one open popup, and every fade.
...
struct ControlPose
{
    std::uint32_t  HoverOrdinal = 0u;      // [-] - eased, zero quiet to one hovered
...
public:
    ...
    /// post  the ledger is empty and Register may be called
    /// cost  ✔️
    ...
    /// 🧩 Returns the ledger to its constructed condition, retiring every registered identity.
...
private:
    ...
    std::uint32_t Slot(ControlIdentity Target) const;
    ...
    std::uint32_t      RegisteredSlots                 = 0u;        // [-] - how many have been claimed

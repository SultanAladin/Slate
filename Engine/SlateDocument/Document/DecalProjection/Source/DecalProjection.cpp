                                             ...
                                             const std::vector<DomainCoordinate>&  CornerCoordinates)
{
    ...
    if (Placed.Mode == PlacementMode::DomainPlaced)
    {
        ...
        return Outcome<DomainExtent>::Deliver(Derived);
    }
...
Outcome<std::uint32_t> PlacementIndex::Declare(const PlacementSpecification& Declaring)
{
    ...
    return Outcome<std::uint32_t>::Deliver(PlacementOrdinal);
}
...
Outcome<const PlacementSpecification*> PlacementIndex::Resolve(std::uint32_t PlacementOrdinal) const
{
    ...
    return Outcome<const PlacementSpecification*>::Deliver(&Placements[PlacementOrdinal].Declared);
}
...
Outcome<PlacementSpecification> PlacementSequence::Abandon()
{
    ...
    return Outcome<PlacementSpecification>::Deliver(Restored);
}
...
Outcome<PlacementSpecification> PlacementSequence::Seal()
{
    ...
    return Outcome<PlacementSpecification>::Deliver(Sealed);
}

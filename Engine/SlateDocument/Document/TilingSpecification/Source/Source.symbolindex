...
%scope      folder
%path       Engine/SlateDocument/Document/TilingSpecification/Source
%layer      SlateDocument
%sources    1
%symbols    16
%annotated  0/16
...
S TilingSpecification.cpp | 246 lines | 7e6d6fda | 16 sym | Lattice validation, the per-cell variation that is a permutation rather than a sample, and the nesting bound.
...
F TilingSpecification::Lattice             | TilingSpecification.cpp | 171     | - | - | ?
    out   -  const LatticeSpecification&  [-]  ?

F TilingSpecification::Content             | TilingSpecification.cpp | 172     | - | - | ?
    out   -  const std::vector<CellContent>&  [-]  ?

F TilingSpecification::Variation           | TilingSpecification.cpp | 173     | - | - | ?
    out   -  const VariationSpecification&  [-]  ?

F TilingSpecification::NestingDepth        | TilingSpecification.cpp | 174     | - | - | ?
    out   -  std::uint32_t  [-]  ?

F TilingSpecification::LatticeDeclared     | TilingSpecification.cpp | 175     | - | - | ?
    out   -  bool  [-]  ?

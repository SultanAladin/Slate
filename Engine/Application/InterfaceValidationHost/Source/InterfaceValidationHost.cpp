...
constexpr std::uint32_t ShellControls   = GlobalShellPanel::EnrolmentDemand;   // [-] - chrome, outline rows,
                                                                              //       layer rows, metadata
constexpr std::uint32_t StackControls   = LayerStackPanel::EnrolmentDemand;   // [-] - rows, chrome,

...
Outcome<bool> PromotionScheduler::DeclareBudget(const PromotionBudget& Declaring)
{
...
Outcome<bool> PromotionScheduler::OpenRotation(std::uint64_t RotationOrdinal)
{

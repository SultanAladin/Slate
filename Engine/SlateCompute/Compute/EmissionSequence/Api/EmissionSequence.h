...
public:
    ...
    /// out   Outcome       [-]  refuses with HostDenied before Construct and while an emission stands, with
    ...
    /// out   Outcome   [-]  refuses with HostDenied before Open, with ExtentExhausted once every row is
    ...
    /// out   Outcome  [-]  refuses with HostDenied before Open and with ExtentExhausted while rows remain

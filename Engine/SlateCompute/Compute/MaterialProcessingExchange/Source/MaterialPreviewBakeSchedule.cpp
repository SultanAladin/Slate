...
Outcome<MaterialPreviewBakeJob> MaterialPreviewBakeSchedule::Schedule(
    const MaterialPreviewTile& Tile, const MaterialProcessingSnapshot& Snapshot) const
{
    ...
    {
        return Outcome<MaterialPreviewBakeJob>::Refuse(
    ...
    return Outcome<MaterialPreviewBakeJob>::Result(Job);
}

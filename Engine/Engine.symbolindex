...
I Source | Application | Engine/Application/ConsoleHost/Source/Source.symbolindex | 1 src | 25 sym | Headless bring-up in link order — every unit constructed, reported, and reclaimed without a window.

//------------------------------------------------------------------------------------------------------------------------
//                                                        CONTRACT
//------------------------------------------------------------------------------------------------------------------------

I Contract | Contract | Engine/Contract/Contract.symbolindex | 6 src | 84 sym | The five combination behaviours `22` §3 declares — read by impressions, by layer entries and by cell content alike.

//------------------------------------------------------------------------------------------------------------------------
//                                                         SHARED
//------------------------------------------------------------------------------------------------------------------------

I Shared | Shared | Engine/Shared/Shared.symbolindex | 15 src | 140 sym | The count-derived weight, the four rejection tests, and the saturating ceiling that keeps a still workspace responsive.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/DisplayProjection/Api/Api.symbolindex           | 1 src | 17 sym  | `66` — exposure on radiance, one monotonic compression, then primaries and transfer through `36` exactly once.
I Source | SlateCompute | Engine/SlateCompute/Compute/DisplayProjection/Source/Source.symbolindex     | 1 src | 11 sym  | Exposure first, compression second, primaries third, transfer once — and the refusal that stops one monitor being every monitor.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/EmissionSequence/Api/Api.symbolindex            | 1 src | 17 sym  | `50` §5 — an export resolved from the domain at its declared extent, band by band, never read back from residency.
I Source | SlateCompute | Engine/SlateCompute/Compute/EmissionSequence/Source/Source.symbolindex      | 1 src | 8 sym   | `50` §5 — the band walk that resolves an emitted image out of the domain, one texel centre at a time.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/IntersectionOutline/Api/Api.symbolindex         | 1 src | 12 sym  | `26` — the enrolled set's silhouette, derived from `16`'s targets alone and recorded over the display after `66`.
I Source | SlateCompute | Engine/SlateCompute/Compute/IntersectionOutline/Source/Source.symbolindex   | 1 src | 11 sym  | Two indexed lookups, one interval comparison, a scalar coverage — and the refusal that stops an occluded outline being merely dimmer.
I Api    | SlateCompute | Engine/SlateCompute/Compute/OcclusionProjection/Api/Api.symbolindex         | 1 src | 41 sym  | `60`'s two occlusion terms, kept apart — the per-illuminant projection that attenuates the direct term, and the scalar hemisphere that attenuates the ambient.
I Source | SlateCompute | Engine/SlateCompute/Compute/OcclusionProjection/Source/Source.symbolindex   | 1 src | 32 sym  | Six faces about a position, a subdivision snapped against shimmer, the packing that truncates rather than drops, and the rebuild that almost never runs.
I Api    | SlateCompute | Engine/SlateCompute/Compute/OverlayProjection/Api/Api.symbolindex           | 1 src | 11 sym  | `80` — non-occupant geometry the artist needs to see, as two recordings whose depth behaviour is opposite and never merged.
I Source | SlateCompute | Engine/SlateCompute/Compute/OverlayProjection/Source/Source.symbolindex     | 1 src | 10 sym  | Two declarations that differ in exactly one behaviour, presence read straight out of `76`, and nothing that could ever be picked.
...
I Source | SlateCompute | Engine/SlateCompute/Compute/ParityRunner/Source/Source.symbolindex          | 1 src | 8 sym   | Registration and comparison over the common sample set.
I Api    | SlateCompute | Engine/SlateCompute/Compute/PreviewProjection/Api/Api.symbolindex           | 1 src | 26 sym  | `82` — what an action will produce, shown before it is committed to, as one speculative extent four consumers share.
I Source | SlateCompute | Engine/SlateCompute/Compute/PreviewProjection/Source/Source.symbolindex     | 1 src | 17 sym  | `82` — the four previews resolved on the host, each one discarded and re-resolved every rotation.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/ReflectanceIntegrator/Api/Api.symbolindex       | 1 src | 26 sym  | `18` — attributes reconstructed rather than read, channels resolved rather than walked, and one target written at every pixel.
I Source | SlateCompute | Engine/SlateCompute/Compute/ReflectanceIntegrator/Source/Source.symbolindex | 1 src | 37 sym  | Attributes reconstructed from two ordinals, channels resolved once, the four lobes composed, and the lookup that keeps them energy-correct.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/SampleIntegrator/Api/Api.symbolindex            | 1 src | 17 sym  | `64` — one sample per rotation accumulated into convergence, reprojected by motion and reset rather than decayed.
I Source | SlateCompute | Engine/SlateCompute/Compute/SampleIntegrator/Source/Source.symbolindex      | 1 src | 12 sym  | Motion-driven reprojection, the count-derived weight, and the reset that never decays.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/SpecularProjection/Api/Api.symbolindex          | 1 src | 15 sym  | `30` — screen-space reflection over depth already resolved and radiance already shaded, composed so that nothing is counted twice.
I Source | SlateCompute | Engine/SlateCompute/Compute/SpecularProjection/Source/Source.symbolindex    | 1 src | 9 sym   | The half-extent claim, the amending recording ordered after `62`, and the composite that cancels to nothing on every failure.
...
I Api    | SlateCompute | Engine/SlateCompute/Compute/TransmissionSequence/Api/Api.symbolindex        | 1 src | 18 sym  | `62` — cutout resolved at `16` and never here, transmissive collected into a bounded sorted column, and amended back to front.
I Source | SlateCompute | Engine/SlateCompute/Compute/TransmissionSequence/Source/Source.symbolindex  | 1 src | 14 sym  | The classification that keeps foliage cheap, the sorted insertion that discards the farthest, and the walk that reads the column backwards.
I Api    | SlateCompute | Engine/SlateCompute/Compute/UvSurfaceDepot/Api/Api.symbolindex              | 1 src | 13 sym  | `24` — attributes moved from a dense topology onto a sparse one through the domain, converging, and keyed by content.
I Source | SlateCompute | Engine/SlateCompute/Compute/UvSurfaceDepot/Source/Source.symbolindex        | 1 src | 13 sym  | A Tier A extent test, a rule that chooses among what it admitted, sweeps that converge — and a miss recorded as a miss.
...
I Api    | SlateDocument | Engine/SlateDocument/Document/DocumentSession/Api/Api.symbolindex             | 1 src | 36 sym | `48` §1 — one open document and everything true of it only while it is open, plus every open session at once.
I Source | SlateDocument | Engine/SlateDocument/Document/DocumentSession/Source/Source.symbolindex       | 1 src | 33 sym | `48` §1 — one open document and everything true of it only while it is open, plus every open session at once.
...
I Api    | SlateDocument | Engine/SlateDocument/Document/PersistenceSequence/Api/Api.symbolindex         | 1 src | 9 sym  | `48` §3 — write, verify, replace: the existing file is never touched until a complete replacement has been read back.
I Source | SlateDocument | Engine/SlateDocument/Document/PersistenceSequence/Source/Source.symbolindex   | 1 src | 4 sym  | `48` §3 — write, verify, replace: the existing file is never touched until a complete replacement has been read back.
...
I Api    | SlateDocument | Engine/SlateDocument/Document/PrimitiveStructure/Api/Api.symbolindex          | 1 src | 21 sym | Parametric polygon generation — the closed set of solids every authored surface and every manipulator grip is built from.
I Source | SlateDocument | Engine/SlateDocument/Document/PrimitiveStructure/Source/Source.symbolindex    | 1 src | 21 sym | Parametric polygon generation — the closed set of solids every authored surface and every manipulator grip is built from.
...
I Api    | SlateDocument | Engine/SlateDocument/Document/RecoverySequence/Api/Api.symbolindex            | 1 src | 15 sym | `48` §4 — the per-document journal appended as transactions seal, and the replay that is offered and never applied.
I Source | SlateDocument | Engine/SlateDocument/Document/RecoverySequence/Source/Source.symbolindex      | 1 src | 11 sym | `48` §4 — the per-document journal appended as transactions seal, and the replay that is offered and never applied.
I Api    | SlateDocument | Engine/SlateDocument/Document/ReferenceIndex/Api/Api.symbolindex              | 1 src | 18 sym | `48` §5 — what one document depends on outside itself, each declared embedded or referenced, absence enrolled.
I Source | SlateDocument | Engine/SlateDocument/Document/ReferenceIndex/Source/Source.symbolindex        | 1 src | 15 sym | `48` §5 — what one document depends on outside itself, each declared embedded or referenced, absence enrolled.
...
I Api    | SlateDocument | Engine/SlateDocument/Document/SpatialManipulator/Api/Api.symbolindex          | 1 src | 44 sym | `78` — one manipulator that moves, rotates and scales everything movable, and the grips the artist grasps to do it.
I Source | SlateDocument | Engine/SlateDocument/Document/SpatialManipulator/Source/Source.symbolindex    | 1 src | 46 sym | `78` — the grip layout, the screen-space grasp, and the four drag solves each grip resolves against.
...
I Source | SlateDocument | Engine/SlateDocument/Document/TopologyStructure/Source/Source.symbolindex     | 1 src | 26 sym | Corner run assembly and the seal that closes it.
...
I Api    | SlateDocument | Engine/SlateDocument/Format/ImageCodec/Api/Api.symbolindex                    | 1 src | 6 sym  | `10` §1 — image streams translated to the texels the file carried, at the depth it carried them, and nothing else.
I Source | SlateDocument | Engine/SlateDocument/Format/ImageCodec/Source/Source.symbolindex              | 1 src | 15 sym | `10` §1 — image streams translated to the texels the file carried, at the depth it carried them, and nothing else.
I Api    | SlateDocument | Engine/SlateDocument/Format/TopologyCodec/Api/Api.symbolindex                 | 1 src | 5 sym  | `10` §1 — polygon streams translated exactly as the file wrote them, n-gons and degeneracies included.
I Source | SlateDocument | Engine/SlateDocument/Format/TopologyCodec/Source/Source.symbolindex           | 1 src | 9 sym  | `10` §1 — polygon streams translated exactly as the file wrote them, n-gons and degeneracies included.
I Api    | SlateDocument | Engine/SlateDocument/Format/TypefaceCodec/Api/Api.symbolindex                 | 1 src | 6 sym  | `10` §1 — typeface streams translated into glyph outlines and the metrics that position them.
I Source | SlateDocument | Engine/SlateDocument/Format/TypefaceCodec/Source/Source.symbolindex           | 1 src | 7 sym  | `10` §1 — typeface streams translated into glyph outlines and the metrics that position them.
I Api    | SlateDocument | Engine/SlateDocument/Format/VectorCodec/Api/Api.symbolindex                   | 1 src | 5 sym  | `10` §1 — vector streams translated into `52`'s accepted subset, with every refusal named and positioned.
I Source | SlateDocument | Engine/SlateDocument/Format/VectorCodec/Source/Source.symbolindex             | 1 src | 13 sym | `10` §1 — vector streams translated into `52`'s accepted subset, with every refusal named and positioned.
...
I Api    | SlateMath | Engine/SlateMath/Numeric/LinearSolver/Api/Api.symbolindex               | 1 src | 10 sym | Dense and sparse factorisation — Bounded, and held to refusing a singular system rather than dividing by it.
I Source | SlateMath | Engine/SlateMath/Numeric/LinearSolver/Source/Source.symbolindex         | 1 src | 4 sym  | Partial-pivoted elimination, the refusal at the pivot floor, and the residual taken against the supply.
...
I Api    | SlateMath | Engine/SlateMath/Numeric/TransformProjection/Api/Api.symbolindex        | 1 src | 18 sym | Decomposed transforms, their composition, and the rebasing that precedes every narrowing to 32-bit.
I Source | SlateMath | Engine/SlateMath/Numeric/TransformProjection/Source/Source.symbolindex  | 1 src | 6 sym  | Quaternion composition, matrix derivation, and the 64-bit rebasing subtraction.
...
I Api    | SlateMath | Engine/SlateMath/Platform/ClipboardExchange/Api/Api.symbolindex         | 1 src | 8 sym  | Text and imagery crossing to and from the operating system, taken as a copy that outlives what supplied it.
I Source | SlateMath | Engine/SlateMath/Platform/ClipboardExchange/Source/Source.symbolindex   | 1 src | 15 sym | The host clipboard opened, copied out of, and closed on every path — including the ones that refuse.
I Api    | SlateMath | Engine/SlateMath/Platform/CodeInterchange/Api/Api.symbolindex           | 1 src | 13 sym | Foreign compiled code crossing in — opaque tokens, a verified interface hash, no standard type in a signature.
I Source | SlateMath | Engine/SlateMath/Platform/CodeInterchange/Source/Source.symbolindex     | 1 src | 14 sym | The load, the verification performed before any table is read, and the unload taken on every refusing path.
I Api    | SlateMath | Engine/SlateMath/Platform/FileInterchange/Api/Api.symbolindex           | 1 src | 9 sym  | One stream surface over three file systems — paths, whole streams, and the write-verify-replace sequence.
I Source | SlateMath | Engine/SlateMath/Platform/FileInterchange/Source/Source.symbolindex     | 1 src | 11 sym | Paths, whole streams and the write-verify-replace sequence over the host file system.
I Api    | SlateMath | Engine/SlateMath/Platform/InputExchange/Api/Api.symbolindex             | 1 src | 12 sym | Timestamped device samples crossing in, with absent axes distinguishable from zero-valued ones.
I Source | SlateMath | Engine/SlateMath/Platform/InputExchange/Source/Source.symbolindex       | 1 src | 21 sym | Bounded cyclic arrival ordering over pointer samples, filled from the host's own pointer surface.
I Api    | SlateMath | Engine/SlateMath/Platform/InstructionExchange/Api/Api.symbolindex       | 1 src | 7 sym  | The instruction-set specialisation selected once from the host and recorded, so a result names what produced it.
I Source | SlateMath | Engine/SlateMath/Platform/InstructionExchange/Source/Source.symbolindex | 1 src | 11 sym | The host query, the operating-system consent a wide specialisation additionally needs, and the selection.
I Api    | SlateMath | Engine/SlateMath/Platform/PlatformInterchange/Api/Api.symbolindex       | 1 src | 7 sym  | Process, thread and locale services translated once, so that nothing above Layer0 carries an OS conditional.
I Source | SlateMath | Engine/SlateMath/Platform/PlatformInterchange/Source/Source.symbolindex | 1 src | 7 sym  | Process, thread and locale services over the host, behind the layer's one set of conditionals.
I Api    | SlateMath | Engine/SlateMath/Platform/StorageExchange/Api/Api.symbolindex           | 1 src | 11 sym | Byte ranges arriving from the storage device, so a decode is driven by range arrival rather than by whole-stream completion.
I Source | SlateMath | Engine/SlateMath/Platform/StorageExchange/Source/Source.symbolindex     | 1 src | 10 sym | Declared byte ranges over the host's storage surface, drained in declaration order with the latency each took.
I Api    | SlateMath | Engine/SlateMath/Platform/TickSequence/Api/Api.symbolindex              | 1 src | 6 sym  | Monotonically increasing ordering points, stamped at arrival and never derived at consumption.
I Source | SlateMath | Engine/SlateMath/Platform/TickSequence/Source/Source.symbolindex        | 1 src | 6 sym  | Host timeline over the operating system's monotonic counter.
...
I Api    | SlateUI | Engine/SlateUI/Interface/ChannelPanel/Api/Api.symbolindex             | 1 src | 10 sym  | One material's twenty channels made visible — every row read from `MaterialIndex`, nothing held here.
I Source | SlateUI | Engine/SlateUI/Interface/ChannelPanel/Source/Source.symbolindex       | 1 src | 25 sym  | The twenty channels as three sections — consumed, retained and undeclared — over an API that already exists.
I Api    | SlateUI | Engine/SlateUI/Interface/ControlPanel/Api/Api.symbolindex             | 1 src | 37 sym  | Every primitive control as one immediate-mode free function over a rectangle — no widget owns anything, and the theme arrives by reference.
I Source | SlateUI | Engine/SlateUI/Interface/ControlPanel/Source/Source.symbolindex       | 6 src | 94 sym  | The four choosing controls — a crossing nub, a run of exclusive pills, a dropped list, and a row of independent switches.
I Api    | SlateUI | Engine/SlateUI/Interface/DiagnosticPanel/Api/Api.symbolindex          | 1 src | 8 sym   | The register made visible — reports grouped by their declared class, measures presented at their producer's tier.
I Source | SlateUI | Engine/SlateUI/Interface/DiagnosticPanel/Source/Source.symbolindex    | 1 src | 10 sym  | Seven declared classes presented at three weights, and the measures beneath them — nothing inferred, nothing held.
I Api    | SlateUI | Engine/SlateUI/Interface/GlyphDepot/Api/Api.symbolindex               | 1 src | 22 sym  | Vector glyphs rasterised once and keyed by content — two names sharing bytes share one texture, and no vendor identity escapes.
I Source | SlateUI | Engine/SlateUI/Interface/GlyphDepot/Source/Source.symbolindex         | 1 src | 24 sym  | Drives the vector rasteriser and the staging transfer — the one file in which a glyph becomes a vendor texture identity.
...
I Api    | SlateUI | Engine/SlateUI/Interface/LayerPanel/Api/Api.symbolindex               | 1 src | 6 sym   | The ordered content of one surface made visible — every row read from `SurfaceLayerSequence`, nothing held here.
I Source | SlateUI | Engine/SlateUI/Interface/LayerPanel/Source/Source.symbolindex         | 1 src | 28 sym  | `TexturePaint.tsx`'s layer stack, band for band — the 46 px header, the spine, the 50/50 split row and the 26 px footer.
...
I Api    | SlateUI | Engine/SlateUI/Interface/PropertyPanel/Api/Api.symbolindex            | 1 src | 8 sym   | Any declared property presented without the panel knowing which — one row per declaration, read from `PropertyIndex`.
I Source | SlateUI | Engine/SlateUI/Interface/PropertyPanel/Source/Source.symbolindex      | 1 src | 16 sym  | One row per declaration, dispatched on the declared measure — the panel names no property and never will.
I Api    | SlateUI | Engine/SlateUI/Interface/RevisionPanel/Api/Api.symbolindex            | 1 src | 7 sym   | The transaction sequence made visible and scrubbable — every row read from `RevisionSequence`, nothing held here.
I Source | SlateUI | Engine/SlateUI/Interface/RevisionPanel/Source/Source.symbolindex      | 1 src | 19 sym  | `Inspector.tsx`'s revision timeline over the real sequence — bubble column, spine, card, fold.
I Api    | SlateUI | Engine/SlateUI/Interface/ThemeSpecification/Api/Api.symbolindex       | 1 src | 10 sym  | The one palette and the one set of layout extents every panel reads — resolved once a tick, held by nobody else.
I Source | SlateUI | Engine/SlateUI/Interface/ThemeSpecification/Source/Source.symbolindex | 1 src | 10 sym  | The one translation unit in which an interface colour literal and a layout extent literal are permitted.
I Api    | SlateUI | Engine/SlateUI/Interface/WorkspaceSpace/Api/Api.symbolindex           | 2 src | 75 sym  | The slot ledger a workspace fills at activation and the desk walks each tick — the host names no concrete panel.
I Source | SlateUI | Engine/SlateUI/Interface/WorkspaceSpace/Source/Source.symbolindex     | 6 src | 109 sym | Declaration, release and resolution over a fixed panel ledger — no allocation, no ImGui, no vendor spelling.
...
I Api    | SlateVulkan | Engine/SlateVulkan/Device/DiagnosticExtension/Api/Api.symbolindex       | 1 src | 10 sym | `VK_EXT_debug_utils` — queried, enabled and held, so every device object Slate creates carries a name.
I Source | SlateVulkan | Engine/SlateVulkan/Device/DiagnosticExtension/Source/Source.symbolindex | 1 src | 8 sym  | The loader resolution, the attached sink, the arrival that appends, and the per-object name.
I Api    | SlateVulkan | Engine/SlateVulkan/Device/DisplayScheduler/Api/Api.symbolindex          | 1 src | 19 sym | The presentation chain and the pacing of it — image transitions ordered against a declared latency target.
I Source | SlateVulkan | Engine/SlateVulkan/Device/DisplayScheduler/Source/Source.symbolindex    | 1 src | 15 sym | The scored format, the established chain, the ordered arrival, and the surrender back to the display.
I Api    | SlateVulkan | Engine/SlateVulkan/Device/HardwareMetrics/Api/Api.symbolindex           | 1 src | 17 sym | Hardware execution duration, measured between recorded timestamps — and reported unavailable rather than zero.
I Source | SlateVulkan | Engine/SlateVulkan/Device/HardwareMetrics/Source/Source.symbolindex     | 1 src | 13 sym | The timestamp extent, the recorded pair around each declared span, and the readback that reports or refuses.
I Api    | SlateVulkan | Engine/SlateVulkan/Device/ImageSpace/Api/Api.symbolindex                | 1 src | 19 sym | Device image extents — claimed against a declared shape, viewed once, and carrying the layout each one stands in.
I Source | SlateVulkan | Engine/SlateVulkan/Device/ImageSpace/Source/Source.symbolindex          | 1 src | 14 sym | The image claim, the one place a layout transition is recorded, and the reclamation that returns both.
...
I Api    | SlateVulkan | Engine/SlateVulkan/Device/SpanSpace/Api/Api.symbolindex                 | 1 src | 18 sym | Device linear extents, each sliced out of ByteSpace and each declaring what the device is permitted to read it as.
I Source | SlateVulkan | Engine/SlateVulkan/Device/SpanSpace/Source/Source.symbolindex           | 1 src | 12 sym | The claim, the host write, the recorded transfer and the release of every linear device extent the engine holds.

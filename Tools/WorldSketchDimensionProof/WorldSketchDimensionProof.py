#!/usr/bin/env python3
"""Builds and runs the camera-free world dimension proof."""
...
OWNED = [
    "Tools/WorldSketchDimensionProof/WorldSketchDimensionProof.cpp",
    "Engine/SlateShape/World/WorldSketchStructure/Source/WorldSketchStructure.cpp",
    "Engine/SlateShape/World/WorldSketchDimensionSolver/Source/WorldSketchDimensionSolver.cpp",
    "Engine/SlateWorkspace/Discipline/WorldSketchDimensionAuthoring/Source/WorldSketchDimensionAuthoring.cpp",
]
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchDimensionProof" / (pathlib.Path(source).stem + ".o")
    command = ["g++", "-std=c++20", "-ffunction-sections", "-fdata-sections", "-c", source,
               "-o", str(obj)] + INCLUDES
...
def main() -> int:
    ...
    binary = ROOT / "Tools/WorldSketchDimensionProof/WorldSketchDimensionProof"

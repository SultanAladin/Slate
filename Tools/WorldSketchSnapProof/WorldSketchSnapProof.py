#!/usr/bin/env python3
"""Builds and runs the world-sketch semantic snap proof."""
...
OWNED = [
    "Tools/WorldSketchSnapProof/WorldSketchSnapProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchSnapProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchSnapProof" / "WorldSketchSnapProof"

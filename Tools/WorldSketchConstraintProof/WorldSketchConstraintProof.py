#!/usr/bin/env python3
"""Builds and runs the camera-free world constraint proof."""
...
OWNED = [
    "Tools/WorldSketchConstraintProof/WorldSketchConstraintProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchConstraintProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchConstraintProof" / "WorldSketchConstraintProof"

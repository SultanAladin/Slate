#!/usr/bin/env python3
"""Builds and runs the three-point-arc proof.
...
OWNED = [
    "Tools/ThreePointArcProof/ThreePointArcProof.cpp",
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "ThreePointArcProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "ThreePointArcProof" / "ThreePointArcProof"

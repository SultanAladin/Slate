...
%scope      folder
%path       Engine/SlateDocument/Format/FormatCodec/Source
%layer      SlateDocument
%sources    1
%symbols    2
%annotated  0/2
...
S FormatCodec.cpp | 76 lines | 11a282b9 | 2 sym | Migration chain resolution over the declared version transformations.

//------------------------------------------------------------------------------------------------------------------------
//                                                  DECLARED MIGRATIONS
//------------------------------------------------------------------------------------------------------------------------

V DeclaredSignature | FormatCodec.cpp | 26    | - | - | ?

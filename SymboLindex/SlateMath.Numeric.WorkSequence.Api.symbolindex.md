...
S WorkSequence.h | 367 lines | 8b47373d | 39 sym | The only thread creation in the repository — declared work, immutable inputs, results applied on the tick.
...
F WorkProgress::DeclareCount           | WorkSequence.h | 112-119 | api,nonallocating,nonthrowing | ✔️ | Declares the resolved count out of the spanned count, and the fraction they imply.
    ...
    out   -         void           [-]  ?
    by    Api/ReportSequence.h, Source/ChartPartition.cpp, Source/ConsoleHost.cpp, Source/ReportSequence.cpp, Source/SurfaceTileSpace.cpp

F WorkProgress::Fraction               | WorkSequence.h | 124     | api,nonallocating,nonthrowing | ✔️ | The resolved fraction as last declared.
    out   -  double  [-]  ?
    by    Shader/MultiScatterSurface.slang, Source/AtmosphereIntegrator.cpp, Source/BrushSpecification.cpp, Source/CurveSolver.cpp, Source/IlluminantPopulation.cpp, Source/ImpressionSequence.cpp, (+2 more)

F WorkProgress::ResolvedCount          | WorkSequence.h | 129     | api,nonallocating,nonthrowing | ✔️ | The resolved count as last declared.
    out   -  std::uint64_t  [-]  ?
    by    Api/ImpressionSequence.h, Api/ShaderCodec.h, Api/SurfaceDepot.h, Source/ConsoleHost.cpp, Source/ImpressionSequence.cpp, Source/ShaderCodec.cpp, (+2 more)
...
F WorkProgress::SpannedCount           | WorkSequence.h | 134     | api,nonallocating,nonthrowing | ✔️ | The spanned count as last declared; zero declares the span unknown.
    out   -  std::uint64_t  [-]  ?
    by    Api/IlluminantPopulation.h, Api/PopulationIndex.h, Api/SceneStructure.h, Api/SurfaceLayerSequence.h, Source/ConsoleHost.cpp, Source/IlluminantPopulation.cpp, (+4 more)
...
F WorkQueue::Admit                     | WorkSequence.h | 203     | api,nonthrowing               | 🚩 | Admits one record ordinal at the end of the order.
    ...
    out   -              void           [-]  ?
    by    Api/PointerIntersection.h, Api/RequestQueue.h, Api/SceneStructure.h, Api/SpatialSubdivision.h, Source/ConsoleHost.cpp, Source/OutlinerSequence.cpp, (+5 more)
...
F WorkQueue::Claim                     | WorkSequence.h | 209     | api,nonallocating,nonthrowing | ✔️ | Claims the earliest pending record ordinal.
    ...
    by    Api/ByteSpace.h, Api/DescriptorIndex.h, Api/ImageSpace.h, Api/RenderSchedule.h, Api/SpanSpace.h, Api/StrokeSpace.h, (+13 more)
...
F WorkQueue::PendingCount              | WorkSequence.h | 219     | api,nonallocating,nonthrowing | ✔️ | How many declarations are pending here.
    out   -  std::uint32_t  [-]  ?
    by    Api/ImpressionSequence.h, Source/ConsoleHost.cpp, Source/ImpressionSequence.cpp, Source/WorkSequence.cpp

//------------------------------------------------------------------------------------------------------------------------
//                                                      THE SEQUENCE
//------------------------------------------------------------------------------------------------------------------------

T WorkSequence                         | WorkSequence.h | 239-365 | owning                        | -  | The workers, their lifetime, and the dispatch order over three priority levels. `50`, `68`, `20`, `24`, `70` and `82` is declared into this and applied by its requester on the tick. delivers completions ordered by declaration ordinal for exactly that reason — an application order that followed completion order would make the same inputs produce two documents on two machines.
...
F WorkSequence::Construct              | WorkSequence.h | 260     | api,nonthrowing               | 🔴 | Constructs the workers, once, at bring-up. the host report and the call moves there when it exists.
...
F WorkSequence::Declare                | WorkSequence.h | 270     | api,nonthrowing               | 🚩 | Declares one unit of work, to be resolved by a worker. declaration carries no resolution claims it; nothing about the calling thread decides when.
...
F WorkSequence::Withdraw               | WorkSequence.h | 278     | api,nonthrowing               | ✔️ | Withdraws one declaration, because the requester no longer wants it.
...
F WorkSequence::Supersede              | WorkSequence.h | 286     | api,nonthrowing               | ✔️ | Withdraws one declaration because a newer one replaces it. superseded cancellation ordinary operation, so nothing is appended to the register for it.
...
F WorkSequence::Progress               | WorkSequence.h | 308     | api,nonthrowing               | ✔️ | One declaration's resolved fraction.
    in    Subject  WorkIdentity  [-]  ?
...
F WorkSequence::ProgressCount          | WorkSequence.h | 314     | api,nonthrowing               | ✔️ | One declaration's resolved count.
    in    Subject  WorkIdentity  [-]  ?
    out   -        Outcome       [-]  refuses with IdentityStale once the declaration has concluded
    by    Source/WorkSequence.cpp

F WorkSequence::WorkerCount            | WorkSequence.h | 319     | api,nonallocating,nonthrowing | ✔️ | How many workers stand.
    out   -  std::uint32_t  [-]  ?
    by    Source/ConsoleHost.cpp, Source/WorkSequence.cpp

F WorkSequence::OccupiedWorkers        | WorkSequence.h | 324     | api,nonallocating,nonthrowing | ✔️ | How many workers are resolving something now.
    out   -  std::uint32_t  [-]  ?
    by    Source/WorkSequence.cpp

F WorkSequence::PendingCount           | WorkSequence.h | 329     | api,nonallocating,nonthrowing | ✔️ | How many declarations are pending across every priority.
    out   -  std::uint32_t  [-]  ?
    by    Api/ImpressionSequence.h, Source/ConsoleHost.cpp, Source/ImpressionSequence.cpp, Source/WorkSequence.cpp

F WorkSequence::Reclaim                | WorkSequence.h | 335     | api,nonthrowing               | 🔴 | Withdraws everything pending, joins every worker, and returns the sequence to its unconstructed state.
    out   -  void  [-]  ?
    post  every pending declaration has concluded as Withdrawn and is drainable
    by    Api/AttachmentIndex.h, Api/ByteSpace.h, Api/CommandSequence.h, Api/CycleScheduler.h, Api/DepthReduction.h, Api/DescriptorIndex.h, (+49 more)

F WorkSequence::Serve                  | WorkSequence.h | 344     | -                             | -  | ?
    in    WorkerOrdinal  std::uint32_t  [-]  ?
    out   -              void           [-]  ?
    by    Source/WorkSequence.cpp

F WorkSequence::Claimable              | WorkSequence.h | 345     | -                             | -  | ?
    in    WorkerOrdinal  std::uint32_t  [-]  ?
    out   -              bool           [-]  ?
    by    Source/WorkSequence.cpp

F WorkSequence::Claim                  | WorkSequence.h | 346     | -                             | -  | ?
    in    WorkerOrdinal  std::uint32_t  [-]  ?
    out   -              std::uint32_t  [-]  ?
    by    Api/ByteSpace.h, Api/DescriptorIndex.h, Api/ImageSpace.h, Api/RenderSchedule.h, Api/SpanSpace.h, Api/StrokeSpace.h, (+13 more)

F WorkSequence::Seal                   | WorkSequence.h | 347     | -                             | -  | ?
    in    RecordOrdinal  std::uint32_t         [-]  ?
    in    Resolved       const Outcome<bool>&  [-]  ?
    out   -              void                  [-]  ?
...
F WorkSequence::Cancel                 | WorkSequence.h | 348     | -                             | -  | ?
    in    Subject            WorkIdentity   [-]  ?
    in    SupersessionPosed  bool           [-]  ?
    out   -                  Outcome<bool>  [-]  ?
    by    Source/WorkSequence.cpp

F WorkSequence::Resolved               | WorkSequence.h | 349     | -                             | -  | ?
    in    Subject  WorkIdentity   [-]  ?
    out   -        std::uint32_t  [-]  ?
    by    Api/ImpressionSequence.h, Api/PointerIntersection.h, Api/SceneStructure.h, Api/SpatialSubdivision.h, Shader/AtmosphereUniform.slang, Shader/VisibilityCorner.slang, (+17 more)

...
E PathContent                              | Api/FileInterchange.h           | 26-32   | What the file system reports a path currently names. caller asked for and acts on. A refusal names a file system that declined to answer at all, which is a different fact and is reported through `Deliver` instead.

...
F InterfaceExchange::Advance            | InterfaceExchange.h | 79     | api,nonthrowing               | ✔️ | Opens one interface tick and reads the window system's accumulated condition.
    ...
    by    Api/CycleScheduler.h, Api/OutlinerSequence.h, Api/RevisionSequence.h, Api/SelectionSequence.h, Api/TickSequence.h, Api/VectorInterchange.h, (+18 more)
...
F InterfaceExchange::Seal               | InterfaceExchange.h | 86     | api,nonthrowing               | 🚩 | Closes the open tick and assembles its command content, ready to record.
    ...
    by    Api/CameraProjection.h, Api/DecalProjection.h, Api/DocumentSession.h, Api/EmissionSequence.h, Api/ImpressionSequence.h, Api/RevisionSequence.h, (+19 more)
...
F InterfaceExchange::Record             | InterfaceExchange.h | 94     | api,nonthrowing               | 🚩 | Records the assembled content into a command recording of the current rotation slot.
    ...
    pre   Seal delivered
    by    Api/InputExchange.h, Api/IntakeIndex.h, Api/VisibilityRaster.h, Source/AssetInterchange.cpp, Source/ConsoleHost.cpp, Source/InputExchange.cpp, (+5 more)

...
%scope      folder
%path       Engine/SlateMath/Numeric/LinearSolver/Source
%layer      SlateMath
%sources    1
%symbols    4
%annotated  0/4
...
S LinearSolver.cpp | 294 lines | af19d670 | 4 sym | Partial-pivoted elimination, the refusal at the pivot floor, and the residual taken against the supply.

//------------------------------------------------------------------------------------------------------------------------
//                                                    THE ELIMINATION
//------------------------------------------------------------------------------------------------------------------------

F Eliminate | LinearSolver.cpp | 27-152  | - | - | ?
    in    Working       std::vector<double>&   [-]  ?
...
F Measure   | LinearSolver.cpp | 255-292 | - | - | ?
    in    Declaring  const DenseSystem&   [-]  ?
    in    Solved     const SolvedSystem&  [-]  ?
    out   -          double               [-]  ?
    by    Api/LinearSolver.h, Api/UnwrapSolver.h, Source/ChartPartition.cpp, Source/UnwrapSolver.cpp

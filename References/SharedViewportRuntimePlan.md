...
3. **Shared authoring dispatch**
   ...
   - Status: in progress; the shared entry point now handles line, polyline, rectangle, and circle records. The remaining arc, spline, dimension, snapping, and preview helpers still need extraction from the Parametric host.

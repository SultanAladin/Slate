...
- Next: complete real midpoint/symmetry/concentric solver subjects, selected-boundary extend UI, split/duplicate/undo-redo transaction surfacing, CAD-grade offset/fillet/chamfer previews, and deeper mode-specific property editing for the expanded sketch tools.

...
- Next: complete real midpoint/symmetry/concentric solver subjects, selected-boundary extend UI, split/duplicate/undo-redo transaction surfacing, and CAD-grade offset/fillet/chamfer previews.
